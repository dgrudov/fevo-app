          ...
          {(() => {
            ...
            return (
              <div style={{ margin: "12px 16px 0", display: "flex", gap: 8 }}>
                ...
                <a href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(shareUrl)}`} target="_blank" rel="noreferrer" style={{ ...btnBase, background: "#1877F215", color: "#1877F2", borderColor: "#1877F230" }}>
