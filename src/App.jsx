          ...
          {(() => {
            ...
            return (
              <div style={{ margin: "12px 16px 0", display: "flex", gap: 8 }}>
                <a href={`https://wa.me/?text=${encodeURIComponent(shareText)}`} target="_blank" rel="noreferrer" style={{ flex: 1, padding: 14, borderRadius: 14, fontSize: 15, fontWeight: 700, background: "#25D36615", color: "#25D366", border: "1px solid #25D36630", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, textDecoration: "none" }}>
                ...
                }} style={{ flex: 1, padding: 14, borderRadius: 14, fontSize: 15, fontWeight: 700, background: "var(--bg3)", color: "var(--text2)", border: "1px solid var(--border2)", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}>
                  🔗 Copy Link
                </button>
              </div>
            );
